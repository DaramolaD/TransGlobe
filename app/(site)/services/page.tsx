          ...
          <div className="space-y-12">
            {services.map((service, index) => (
              <motion.div
                ...
                className="bg-platinum-off rounded-2xl p-8 border border-border/50 hover:shadow-lg transition-all duration-300"
              >
                <div className="flex flex-wrap items-start gap-8">
                  {/* Service Icon & Title */}
                  <div className="flex-1 text-center lg:text-left">
                    <div className="w-20 h-20 icon-tile rounded-2xl flex items-center justify-center mx-auto lg:mx-0 mb-6">
                  ...
                  <div className="flex-1 pt-10 space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="flex items-center space-x-3">
                        <Clock className="w-5 h-5 text-graphite-mid flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-center space-x-3">
                        <DollarSign className="w-5 h-5 text-graphite-mid flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-center space-x-3">
                        <MapPin className="w-5 h-5 text-graphite-mid flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-center space-x-3">
                        <Package className="w-5 h-5 text-graphite-mid flex-shrink-0" />
                    <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {additionalServices.map((service, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white rounded-2xl p-8 border border-border/50 hover:border-graphite-mid/30 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                <div className="w-16 h-16 icon-tile rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300">
                  ...
                  <button className="text-graphite-mid hover:text-ember-main font-medium flex items-center space-x-2 group-hover:translate-x-1 transition-all">
                    ...
                    <tr key={service.title} id={`${service.id}-comparison`} className="border-b border-border/30 hover:bg-slate-50/50 transition-colors">
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          <div className="p-3 !m-0 icon-tile rounded-lg flex items-center justify-center">
                      ...
                      <td className="text-center p-4">
                        <div className="font-semibold text-graphite-dark">{service.startingPrice}</div>
                      </td>
                      <td className="text-center p-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="bg-white rounded-2xl p-8 border border-border/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group"
              >
                <div className="w-16 h-16 icon-tile rounded-xl flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300">
