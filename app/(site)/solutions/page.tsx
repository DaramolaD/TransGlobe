        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-16">
            {industrySolutions.map((solution, index) => (
              ...
              >
                <div>
                  <div className="w-20 h-20 icon-tile rounded-2xl flex items-center justify-center mb-6">
                    ...
                    <ul className="space-y-2">
                      {solution.benefits.map((benefit) => (
                        <li key={benefit} className="text-sm text-muted-foreground flex items-center space-x-2">
                          <TrendingUp className="w-4 h-4 text-graphite-mid flex-shrink-0" />
                          <span>{benefit}</span>
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="space-y-4">
                    <div className="bg-white rounded-lg p-4 border border-border/50">
                      <div className="flex items-center space-x-3 mb-2">
                        <Users className="w-5 h-5 text-graphite-mid" />
                    ...
                    <div className="bg-white rounded-lg p-4 border border-border/50">
                      <div className="flex items-center space-x-3 mb-2">
                        <Shield className="w-5 h-5 text-graphite-mid" />
                    ...
                    <div className="bg-white rounded-lg p-4 border border-border/50">
                      <div className="flex items-center space-x-3 mb-2">
                        <Zap className="w-5 h-5 text-graphite-mid" />
            ...
            {caseStudies.map((study, index) => (
              ...
              >
                <div className="mb-6">
                  ...
                  <p className="text-graphite-mid font-medium">{study.industry}</p>
                </div>
