...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background scroll-smooth">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  >
                    <div className="text-3xl font-bold text-graphite-dark">{stat.number}</div>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="w-full h-[500px] bg-gradient-to-br from-graphite-mid/40 to-ember-main/10 rounded-2xl backdrop-blur-custom border border-platinum-light">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            <motion.div
              ...
              className="text-center"
            >
              <div className="w-20 h-20 icon-tile rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="w-20 h-20 icon-tile rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-transform duration-300">
      ...
      {/* Leadership Team */}
      <section id="team" className="py-20 bg-platinum-off">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {leadership.map((leader, index) => (
              <motion.div
                ...
                className="text-center group"
              >
                <div className="w-24 h-24 icon-tile rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-transform duration-300">
                  <span className="text-2xl font-bold text-white">{leader.avatar}</span>
                  </div>
                <h3 className="text-xl font-semibold mb-2 group-hover:text-graphite-dark transition-colors">
                  {leader.name}
                </h3>
                <div className="text-graphite-mid font-medium mb-2">{leader.role}</div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {milestones.map((milestone, index) => (
              <motion.div
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-6 w-4 h-4 bg-ember-main rounded-full border-4 border-white shadow-lg"></div>
                  
                  <div className="ml-16">
                    <div className="bg-platinum-off rounded-2xl p-6 border border-border/50 hover:shadow-lg transition-all duration-300">
                      <div className="flex items-center space-x-4 mb-4">
                        <div className="text-2xl font-bold text-graphite-dark">{milestone.year}</div>
      ...
      {/* Awards & Recognition */}
      <section id="awards" className="py-20 bg-platinum-off">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            {awards.map((award, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="w-16 h-16 icon-tile rounded-xl flex items-center justify-center flex-shrink-0">
                    <Award className="w-8 h-8 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold mb-2">{award.title}</h3>
                    <div className="flex items-center space-x-4 mb-3">
                      <span className="text-graphite-mid font-medium">{award.organization}</span>
