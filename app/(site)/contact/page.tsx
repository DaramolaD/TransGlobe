...
import { submitLead } from "@/lib/actions/public-forms";
...
export default function ContactPage() {
  ...
  const supportChannels = [
    {
      icon: Phone,
      title: "Phone support",
      description: "Speak with our operations team",
      contact: brand.supportPhone,
      response: brand.opsHours,
    },
    {
      icon: Mail,
      title: "Email support",
      description: "Detailed inquiries and quote requests",
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Thank you for contacting {brand.name}. We&apos;ve received your message and
            will get back to you within 2 hours during business hours.
          </p>

          <div className="bg-platinum-off rounded-2xl p-6 border border-border/50 mb-8">
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-dark text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              ...
              help. Contact us today and discover how {brand.name} can streamline
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-border/50 rounded-lg focus:ring-2 focus:ring-ember-main/20 focus:border-primary transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-border/50 rounded-lg focus:ring-2 focus:ring-ember-main/20 focus:border-primary transition-all resize-none"
                ...
                <div className="space-y-6">
                  {supportChannels.map((office, index) => (
                    <div key={index} className="flex items-start space-x-4">
                      <div className="w-12 h-12 icon-tile rounded-xl flex items-center justify-center flex-shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-graphite-mid font-medium">
                          {office.contact}
                        </p>
                      </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {offices.map((office, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 border border-border/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
                <div className="text-center mb-6">
                  <div className="w-16 h-16 icon-tile rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-graphite-mid font-medium">{office.phone}</p>
                  </div>
                  
                  <div className="text-sm">
                    <div className="font-medium mb-1">Email</div>
                    <p className="text-graphite-mid font-medium">{office.email}</p>
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16">
            {[
              ...
              >
                <div className="w-16 h-16 icon-tile rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-transform duration-300">
                  <feature.icon className="w-8 h-8 text-white" />
                </div>

                <h3 className="text-xl font-semibold mb-4 group-hover:text-graphite-dark transition-colors">
                  {feature.title}
                </h3>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-8 leading-relaxed">
              ...
              discover how {brand.name} can transform your shipping operations.
            </p>
