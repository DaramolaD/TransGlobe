            ...
            {plans.map((plan, index) => (
              <motion.div
                ...
                className={`relative rounded-3xl p-8 border-2 transition-all duration-300 ${
                  plan.popular
                    ? "border-primary bg-platinum-off shadow-glow scale-105"
                    : "border-border/50 bg-white hover:shadow-lg hover:-translate-y-1"
                }`}
              >
                {plan.popular && (
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="mb-6">
                    <span className="text-4xl font-bold text-graphite-dark">{plan.price}</span>
                ...
                <div className="space-y-4 mb-8">
                  ...
                  {plan.features.map((feature) => (
                    <div key={feature} className="flex items-center space-x-3">
                      <Check className="w-5 h-5 text-sage-main flex-shrink-0" />
            ...
            {addOns.map((addon, index) => (
              ...
              >
                ...
                <div className="text-center mb-4">
                  <span className="text-2xl font-bold text-graphite-dark">{addon.price}</span>
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="bg-platinum-off rounded-xl p-6 border border-border/50 hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-lg font-semibold mb-4 text-graphite-dark">
                  {faq.question}
                </h3>
