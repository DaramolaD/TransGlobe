          ...
          <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {report.keyInsights.map((insight, index) => (
                  <div
                    ...
                    className="flex items-start space-x-3 p-4 bg-gradient-to-r from-platinum-off to-platinum-off rounded-xl border border-platinum-light"
                  >
                    <CheckCircle className="w-6 h-6 text-graphite-mid flex-shrink-0 mt-1" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {report.content.keyTrends.map((trend, index) => (
                  ...
                  >
                    <TrendingUp className="w-6 h-6 text-graphite-mid flex-shrink-0 mt-1" />
            ...
            >
              ...
              <div className="bg-platinum-off rounded-2xl p-8 border border-border/50">
                <div className="flex items-start space-x-3 mb-4">
                  <Globe className="w-8 h-8 text-graphite-mid flex-shrink-0" />
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-platinum-off rounded-2xl p-6 border border-border/50">
                  <h3 className="text-xl font-semibold mb-4 flex items-center space-x-2">
                    <FileText className="w-6 h-6 text-graphite-mid" />
                ...
                <div className="bg-platinum-off rounded-2xl p-6 border border-border/50">
                  <h3 className="text-xl font-semibold mb-4 flex items-center space-x-2">
                    <BarChart3 className="w-6 h-6 text-graphite-mid" />
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {report.content.authors.map((author, index) => (
                  <div
                    ...
                    // viewport={{ once: true }}
                    // transition={{ duration: 0.6, delay: index * 0.1 }}
                    className="bg-platinum-off rounded-2xl p-6 border border-border/50 text-center hover:shadow-glow transition-all duration-300"
                  >
                    <div className="w-16 h-16 icon-tile rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            >
              <div className="bg-platinum-off rounded-2xl p-8 border border-platinum-light">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {industryReports
              ...
              .map((relatedReport) => (
                ...
                >
                  <div className="mb-4">
                    <span className="inline-block px-3 py-1 bg-ember-main/10 text-graphite-mid text-sm font-medium rounded-full mb-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link href={`/resources/reports/${relatedReport.id}`}>
                      <button
                        className="px-4 py-2 text-graphite-mid hover:text-ember-main font-medium flex items-center space-x-2 transition-colors"
