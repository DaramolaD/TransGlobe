...
import { submitPickup } from "@/lib/actions/public-forms";
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                <h3 className="text-2xl font-display font-bold mb-6 flex items-center space-x-3">
                  <Package className="w-8 h-8 text-graphite-mid" />
                ...
                <div className="grid md:grid-cols-2 gap-6">
                      ...
                      {pickupTypes.map((type) => (
                        ...
                        >
                          <input
                            ...
                            className="sr-only"
                          />
                          <type.icon className="w-5 h-5 text-graphite-mid" />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-ember-main focus:border-transparent transition-all ${
              ...
              >
                <h3 className="text-2xl font-display font-bold mb-6 flex items-center space-x-3">
                  <MapPin className="w-8 h-8 text-graphite-mid" />
              ...
              >
                ...
                <div className="mt-6">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 border border-border/50 rounded-lg focus:ring-2 focus:ring-ember-main focus:border-transparent transition-all resize-none"
                  />
                </div>
              </motion.div>
              ...
              >
                <h3 className="text-2xl font-display font-bold mb-6 flex items-center space-x-3">
                  <User className="w-8 h-8 text-graphite-mid" />
